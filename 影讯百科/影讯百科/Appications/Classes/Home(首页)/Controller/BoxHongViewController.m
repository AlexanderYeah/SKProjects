...
@interface BoxHongViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BoxHongViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WeekBoxModel *model = self.dataArray[indexPath.row];
    [cell setWeekModel:model];
...
{   // 提示用户
    ...
    [manger GET:strUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        self.dataArray = [WeekBoxModel mj_objectArrayWithKeyValuesArray:dataArr];
...
- (NSString *)getNetUrk
{
    ...
    NSString *netStr = [NSString stringWithFormat:@"https://route.showapi.com/578-3?showapi_appid=24123&showapi_timestamp=%@&showapi_sign=fa05402db54e46ec91e2847fa506a34c",dateStr];
    return netStr;
}
