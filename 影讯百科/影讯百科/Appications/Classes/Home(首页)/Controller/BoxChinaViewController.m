...
@interface BoxChinaViewController ()<UITableViewDataSource,UITableViewDelegate>
/** tableView */
...
@implementation BoxChinaViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SingleBoxModel *model = self.dataArray[indexPath.row];
    [cell setModel:model];
...
{   // 提示用户
    ...
    [manger GET:strUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        self.dataArray = [SingleBoxModel mj_objectArrayWithKeyValuesArray:dataArr];
...
- (NSString *)getNetUrk
{
    ...
    NSString *netStr = [NSString stringWithFormat:@"https://route.showapi.com/578-2?showapi_appid=24123&showapi_timestamp=%@&showapi_sign=fa05402db54e46ec91e2847fa506a34c",dateStr];
    return netStr;
}
