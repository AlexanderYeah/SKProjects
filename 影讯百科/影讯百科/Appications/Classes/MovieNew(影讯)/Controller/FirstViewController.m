...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 取出模型
    FirstNewsModel *model = self.dataArray[indexPath.row];
    [cell setModel:model];
...
- (void)requestDataFromNet
{
    ...
    NSString *urlStr = @"http://api.douban.com/v2/movie/in_theaters?apikey=0b2bdeda43b5688921839c8ecb20399b&start=0&count=100";
    ...
    [manger GET:urlStr parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        self.dataArray = [FirstNewsModel mj_objectArrayWithKeyValuesArray:dataArr];
